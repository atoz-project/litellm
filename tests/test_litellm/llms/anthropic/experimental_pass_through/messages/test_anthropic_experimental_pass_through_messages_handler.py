...
# ---------------------------------------------------------------------------
# custom-aigw: per-deployment routing precedence + DashScope Kimi K3 thinking.
# ---------------------------------------------------------------------------
...
def test_declared_responses_mode_wins_over_global_chat_completions_flag(monkeypatch):
    """custom-aigw precedence: a per-deployment declaration beats the global flag."""
    from litellm.llms.anthropic.experimental_pass_through.messages import handler
...
def test_undeclared_deployment_still_follows_global_chat_completions_flag(monkeypatch):
    """The global flag remains the fallback for deployments that declare nothing."""
    from litellm.llms.anthropic.experimental_pass_through.messages import handler

...
# ---------------------------------------------------------------------------
# custom-aigw: DashScope Kimi K3 reasoning → Anthropic thinking blocks.
# The output-side translation is upstream behavior; these pin it so the
# K3 chat-completions path (thinking → extra_body.reasoning_effort="max")
# still surfaces reasoning as thinking blocks.
# ---------------------------------------------------------------------------
